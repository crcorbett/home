---
title: TypeScript Monorepo Configuration
description: Our TypeScript monorepo setup implementing the "live types" pattern for an optimal developer experience
---
