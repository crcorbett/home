---
title: "Phantom Dependencies: How Bun Caught a Latent Bug"
description: How our migration from pnpm to Bun discovered a phantom dependency that had been silently lurking in our codebase
---
